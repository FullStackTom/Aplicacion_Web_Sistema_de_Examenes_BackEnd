...
public class SistemaExamenesBackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
			/*try{
				...
				usuario.setNombre("Tomas Roger");
				usuario.setApellido("Olortegui Requena");
				usuario.setUsername("tomrog");
				usuario.setPassword(bCryptPasswordEncoder.encode("123456"));
				usuario.setEmail("tomy@gmail.com");
				usuario.setTelefono("963852741");
